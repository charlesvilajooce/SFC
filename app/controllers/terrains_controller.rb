class TerrainsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @terrain.save
        format.html { redirect_to terrains_path, notice: 'Terrain was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @terrain.update(terrain_params)
        format.html { redirect_to terrains_path, notice: 'Terrain was successfully updated.' }
