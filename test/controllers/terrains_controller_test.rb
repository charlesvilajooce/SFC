...
class TerrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create terrain" do
    assert_difference('Terrain.count') do
      post terrains_url, params: { terrain: { category: @terrain.category, name: @terrain.name } }
    end
  ...
  test "should update terrain" do
    patch terrain_url(@terrain), params: { terrain: { category: @terrain.category, name: @terrain.name } }
