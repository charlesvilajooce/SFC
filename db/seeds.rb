...
Event.create!([
  {name: "Entrainement", description: "Centre sportif de Balexert", eventtype: 2, begin: 1491897600, end: 1491901200},
  {name: "SFC - FC Sion", description: "Stade de Genève", eventtype: 1, begin: 1491912000, end: 1491915600},
  {name: "FC Bale - SFC", description: "Parc Saint-Jacques", eventtype: 1, begin: 1492074660, end: 1492078260}
])
Subscription.create!([
